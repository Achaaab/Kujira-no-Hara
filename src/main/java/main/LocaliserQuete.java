...
import static utilitaire.ResourceUtility.loadOptionalImage;

/**
 * Lala
 */
public class LocaliserQuete {
	static String adresse = "./resources/Graphics/Pictures/Cartes/";
	static int margeX = 0;
	static int margeY = 0;
	...
	public static void main(final String[] args) throws IOException {
		...
		icone = loadOptionalImage("Graphics/Icons/quete a faire icon.png").orElseThrow();
